...
# Kaggle Dataset 中的只读 .db 文件路径（可选，设置后会在启动时复制到 MILVUS_URI）
# 例如: MILVUS_READONLY_URI="/kaggle/input/adaptive-rag-data/milvus_rag.db"
MILVUS_READONLY_URI = os.environ.get("MILVUS_READONLY_URI", "")
